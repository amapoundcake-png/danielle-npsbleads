...
BLOCKED_EMAILS = {
    ...
    # Hard bounces Aug 29
    "alex@universalstandard.com",
    "booking@jointherevolution.net",
    "booking@miamiimprov.com",
    "booking@sohostudiosmiami.com",
    "ccollins@lotushouse.org",
    "dallas@uss.salvationarmy.org",
    "dmeyers@womenindistress.org",
    "eallen@drinkpoppi.com",
    "english@spelman.edu",
    "entertainment@hardrocktampa.com",
    "erickson@embarccollective.com",
    "events@bbbsla.org",
    "events@clubprana.com",
    "events@groothospitality.com",
    "events@juviamiami.com",
    "events@lolcomedyclub.com",
    "events@orlandofringe.org",
    "events@osc.org",
    "events@sidesplitterscomedy.com",
    "events@tampamuseum.org",
    "events@theblockorlando.com",
    "events@thecitadelmiami.com",
    "gagan@tamaracuisine.com",
    "hello@debonairorlando.com",
    "influencer@uomabeauty.com",
    "info@actforchildren.org",
    "info@amachicago.org",
    "info@amaorlando.org",
    "info@bardotmiami.com",
    "info@bgcgh.org",
    "info@bgcma.org",
    "info@blackgirlventures.org",
    "info@buildchicago.org",
    "info@celineorlando.com",
    "info@chicagocommons.org",
    "info@commodorecomedy.com",
    "info@communityofhopedc.org",
    "info@dcac.org",
    "info@digitalundivided.com",
    "info@diversityspeaker.com",
    "info@finconexpo.com",
    "info@gcjfcs.org",
    "info@goodshepherds.org",
    "info@hopeandhelp.org",
    "info@jlmiami.org",
    "info@jltampa.org",
    "info@loavesandfishesnc.org",
    "info@nashvillerescuemission.org",
    "info@nawbo.org",
    "info@nonprofitctr.org",
    "info@oasiswynwood.com",
    "info@renewalhouse.org",       # unsubscribed Aug 29
    "info@sakcomedylab.com",
    "info@uac.org",
    "info@unitedforimpact.org",
    "info@unitedwayhouston.org",
    "info@unitedwaymiami.org",
    "info@unitedwaynyc.org",
    "info@unitedwaysuncoast.org",
    "info@wbenc.org",
    "info@ywcanashville.com",
    "info@zebracoalition.org",
    "journalism@morgan.edu",
    "kdavis@quigleyhouse.org",
    "lmoore@bbbscfl.org",
    "losangeles@dressforsuccess.org",
    "mandy@tamaracuisine.com",
    "mromero@girlsincmiami.org",
    "ncbw@ncbw.org",
    "newfaces@wilhelmina.com",
    "orlando@donttellcomedy.com",
    "partnerships@jenis.com",
    "programs@girlsincatlanta.org",
    "programs@girlsincjax.org",
    "programs@girlsincla.org",
    "programs@gswcf.org",
    "programs@hawc.org",
    "programs@selahfreedom.com",
    "savanna@patternbeauty.com",
    "smassey@jaguars.com",
    "speakers@afrotech.com",
    "speakers@shemedia.com",
    "sreinas@aliforneycenter.org",
    "submissions@aevitas.com",
    "tasha@blackgirlsinmediainc.com",
    "tbanks@padv.org",
    "tburton@hubbardhouse.org",
    "terria@trapmusicmuseum.com",
    "tgarro@briogeohair.com",
    "ventira@frankiemaefoundation.com",
    "vgarza@sietefoods.com",
    "wilc@uwf.edu",
    "wmcewan@ywca.org",
    "wmeyer@jaguars.com",
    "wstallworth@paintedpin.com",
    "yfarimani@goodamerican.com",
}
...
def _search_api_results(query: str, num: int = 5) -> list[dict]:
    ...
    try:
        ...
        return [{"title": r.get("title", ""), "link": r.get("url", ""), "snippet": r.get("description", "")} for r in raw]
...
DISCOVER_QUERIES_BY_LANE = {
    ...
    "nonprofit_consulting": [
        ("nonprofit organization {city} communications outreach director", "Nonprofit"),
        ("community foundation {city} programs contact", "Nonprofit"),
        ("social services {city} nonprofit executive director", "Nonprofit"),
        ("housing nonprofit {city} community outreach", "Nonprofit"),
        ("civic organization {city} community engagement contact", "Nonprofit"),
        ("community development nonprofit {city} partnerships", "Nonprofit"),
        ("health nonprofit {city} outreach programs contact", "Nonprofit"),
        ("food bank {city} community outreach contact", "Nonprofit"),
        ("human services nonprofit {city} director", "Nonprofit"),
        ("environmental nonprofit {city} community programs", "Nonprofit"),
        ("arts nonprofit {city} community engagement", "Nonprofit"),
        ("education nonprofit {city} outreach programs", "Nonprofit"),
        ("refugee resettlement {city} nonprofit contact", "Nonprofit"),
        ("workforce development nonprofit {city} contact", "Nonprofit"),
        ("literacy nonprofit {city} outreach contact", "Nonprofit"),
        # Expanded Sep 2026
        ("immigrant services nonprofit {city} outreach contact", "Nonprofit"),
        ("veterans nonprofit {city} community programs contact", "Nonprofit"),
        ("disability services nonprofit {city} outreach director", "Nonprofit"),
        ("mental health nonprofit {city} outreach programs contact", "Nonprofit"),
        ("substance abuse recovery nonprofit {city} director", "Nonprofit"),
        ("criminal justice reform nonprofit {city} contact", "Nonprofit"),
        ("affordable housing advocacy nonprofit {city} contact", "Nonprofit"),
        ("early childhood education nonprofit {city} outreach", "Nonprofit"),
        ("adult education literacy nonprofit {city} director", "Nonprofit"),
        ("hunger relief nonprofit {city} community programs", "Nonprofit"),
        ("homeless services nonprofit {city} outreach contact", "Nonprofit"),
        ("disaster relief nonprofit {city} community contact", "Nonprofit"),
        ("civic leadership nonprofit {city} community director", "Nonprofit"),
        ("public health nonprofit {city} community outreach", "Nonprofit"),
        ("youth violence prevention nonprofit {city} contact", "Nonprofit"),
    ],
    "nonprofit_speaking": [
        ("women nonprofit {city} programs events speaker", "Nonprofit"),
        ("domestic violence shelter {city} programs contact", "Nonprofit"),
        ("girls mentoring program {city} contact director", "Nonprofit"),
        ("women leadership nonprofit {city} events", "Nonprofit"),
        ("body image health nonprofit {city}", "Nonprofit"),
        ("women empowerment organization {city} contact", "Nonprofit"),
        ("women's shelter {city} programs contact", "Nonprofit"),
        ("breast cancer nonprofit {city} events speaker", "Nonprofit"),
        ("sisterhood organization {city} nonprofit contact", "Nonprofit"),
        ("sorority nonprofit {city} community programs", "Nonprofit"),
        ("women business owners {city} nonprofit contact", "Nonprofit"),
        ("girls inc {city} programs contact", "Girls Inc"),
        ("YWCA {city} programs events contact", "YWCA"),
        ("women's fund {city} programs events", "Nonprofit"),
    ],
    "youth_speaking": [
        ("youth program {city} nonprofit events speaker", "Nonprofit"),
        ("after school program {city} contact director", "Nonprofit"),
        ("girls mentoring {city} director contact speaker", "Nonprofit"),
        ("teen program {city} speaker booking contact", "Nonprofit"),
        ("youth leadership program {city} contact", "Nonprofit"),
        ("teen girls empowerment program {city}", "Nonprofit"),
        ("boys girls club {city} programs contact", "Boys & Girls Club"),
        ("youth development nonprofit {city} contact", "Nonprofit"),
        ("teen mentoring program {city} speaker contact", "Nonprofit"),
        ("high school leadership program {city} contact", "High School"),
        ("youth entrepreneurship program {city} contact", "Nonprofit"),
        ("college prep program {city} nonprofit contact", "Nonprofit"),
        ("YMCA youth programs {city} contact", "YMCA"),
        ("juvenile justice alternative program {city}", "Nonprofit"),
        ("foster youth program {city} nonprofit contact", "Nonprofit"),
        ("teen girls confidence program {city}", "Nonprofit"),
        ("youth social media digital literacy program {city}", "Nonprofit"),
        ("community center youth programs {city} contact", "Community Center"),
    ],
    "universities": [
        ("university student activities {city} speaker booking", "University"),
        ("college diversity inclusion speaker {city}", "University"),
        ("HBCUs {city} student programming speaker contact", "HBCU"),
        ("community college student services {city} speaker", "Community College"),
        ("university women center {city} programming contact", "University"),
        ("college career development speaker {city}", "University"),
        ("student government association {city} speaker booking", "University"),
        ("university multicultural affairs {city} programming", "University"),
        ("college health wellness speaker {city}", "University"),
        ("university first generation student programs {city}", "University"),
        ("college personal branding speaker {city}", "University"),
        ("university leadership institute {city} speaker", "University"),
    ],
    "brand_partnerships": [
        ("plus size fashion brand {city} influencer marketing", "Fashion Brand"),
        ("beauty brand influencer partnership {city}", "Beauty Brand"),
        ("inclusive fashion brand creator partnership", "Fashion Brand"),
        ("body positive brand influencer contact", "Lifestyle Brand"),
        ("women wellness brand influencer marketing contact", "Wellness Brand"),
        ("lifestyle brand creator partnership {city}", "Lifestyle Brand"),
        ("food beverage brand influencer {city}", "Food Brand"),
        ("travel brand influencer partnership contact", "Travel Brand"),
        ("plus size swimwear brand influencer marketing", "Fashion Brand"),
        ("curvy fashion brand creator partnership contact", "Fashion Brand"),
        ("natural hair beauty brand influencer partnership", "Beauty Brand"),
        ("black owned beauty brand influencer contact", "Beauty Brand"),
        # Expanded Sep 2026 — new query pool to refresh exhausted pipeline
        ("women owned clothing brand creator collaboration contact", "Fashion Brand"),
        ("size inclusive activewear brand influencer partnership", "Activewear Brand"),
        ("ethical fashion brand creator program contact", "Fashion Brand"),
        ("plus size lingerie brand influencer marketing contact", "Fashion Brand"),
        ("black beauty brand creator partnership marketing contact", "Beauty Brand"),
        ("skin care brand influencer program contact", "Beauty Brand"),
        ("hair care brand influencer collaboration contact", "Beauty Brand"),
        ("makeup brand creator partnership diversity contact", "Beauty Brand"),
        ("women health brand creator partnership contact", "Health Brand"),
        ("mental wellness app brand influencer contact", "Wellness Brand"),
        ("femtech brand creator partnership marketing", "Tech Brand"),
        ("women finance brand influencer partnership contact", "Finance Brand"),
        ("home decor brand creator partnership {city}", "Lifestyle Brand"),
        ("subscription box brand influencer collaboration contact", "Lifestyle Brand"),
        ("black owned food brand creator partnership contact", "Food Brand"),
        ("women owned wine spirits brand influencer contact", "Food Brand"),
        ("hotel resort brand creator partnership contact", "Travel Brand"),
        ("airline travel brand creator influencer partnership", "Travel Brand"),
        ("cultural travel experience brand influencer contact", "Travel Brand"),
        ("women empowerment brand creator ambassador contact", "Lifestyle Brand"),
    ],
    "talent_representation": [
        ("talent agency commercial actors {city} submissions", "Talent Agency"),
        ("talent agency on camera hosts {city}", "Talent Agency"),
        ("commercial talent agency {city} contact submissions", "Talent Agency"),
        ("lifestyle talent agency influencer representation", "Talent Agency"),
        ("speakers bureau keynote speaker submissions contact", "Speakers Bureau"),
        ("talent agency plus size models {city}", "Talent Agency"),
        ("commercial print talent agency {city}", "Talent Agency"),
        ("influencer talent management agency contact", "Talent Agency"),
        ("speakers bureau diversity speaker submissions", "Speakers Bureau"),
        ("entertainment talent agency {city} submissions", "Talent Agency"),
        # Expanded Sep 2026
        ("host talent agency lifestyle TV contact submissions", "Talent Agency"),
        ("commercial hosting talent agency {city} contact", "Talent Agency"),
        ("on camera talent management firm submissions contact", "Talent Agency"),
        ("broadcast talent agency host personality submissions", "Talent Agency"),
        ("digital creator talent agency management contact", "Talent Agency"),
        ("women speaker bureau diversity submissions contact", "Speakers Bureau"),
        ("motivational speaker bureau submissions booking", "Speakers Bureau"),
        ("keynote speaker representation firm contact submissions", "Speakers Bureau"),
        ("brand ambassador talent agency management contact", "Talent Agency"),
        ("podcast host talent agency representation contact", "Talent Agency"),
        ("lifestyle influencer management agency submissions", "Talent Agency"),
        ("multicultural talent agency commercial submissions {city}", "Talent Agency"),
    ],
